...
public class PinyinUtils {
    ...
    public static String[] pystr = new String[] {"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
            ...
            "zhun", "zhuo", "zi", "zong", "zou", "zu", "zuan", "zui", "zun", "zuo"};private StringBuilder buffer;
    ...
    public boolean isChinese(String chs) {
        if (chs == null) {
            return false;
        }
    ...
    public char getFirstLetter(String chs) {
        if (isChinese(chs)) {
            return getSelling(chs).toUpperCase().charAt(0);
        }
        else if (chs.toUpperCase().charAt(0) <= 'Z' &&
                chs.toUpperCase().charAt(0) >= 'A'){
            return chs.toUpperCase().charAt(0);
        }
        else {
            return '#';
        }
